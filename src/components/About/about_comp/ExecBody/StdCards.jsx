const StdCards = ({ name, image, role, shortDescription }) => {
  //  alumni student displaying information
  return (
    <div className='group relative mx-auto flex w-full max-w-sm flex-col bg-red shadow-md hover:shadow-2xl border border-slate-200 rounded-2xl my-4 sm:my-6 min-h-[24rem] overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02]'>
      <div className='relative h-52 sm:h-56 w-full overflow-hidden bg-blue-950 hover:cursor-pointer'>
        <img
          src={image}
          alt={name}
      ...
      <div className='p-5 text-center flex flex-col justify-center flex-1'>
